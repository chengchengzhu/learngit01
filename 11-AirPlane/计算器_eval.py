...
#1.界面布局
#显示面板
# result显示面板显示计算结果与输入的数字，默认数字0
# result2显示面板显示计算过程，默认为空
...
result2.set('')
#显示板
label2 = tkinter.Label(root,font = ('微软雅黑',20),bg = '#EEE9E9',bd ='9',fg = '#828282',anchor = 'se',textvariable = result2)
label2.place(width = 280,height = 170)
label = tkinter.Label(root,font = ('微软雅黑',30),bg = '#EEE9E9',bd ='9',fg = 'black',anchor = 'se',textvariable = result)
label.place(y = 170,width = 280,height = 60)
...
def pressEqual():
    ...
    computrStr = ''.join(lists)     #讲列表内容用join命令将字符串链接起来，原lists是单个分离的列表，要将其合成字符串，且分隔符为空
